...
public class TempEquation
{
    ...
    public TempEquation(int highTemp, int lowTemp, double Midpt, double variance)
    {
    ...
    public int generateTodaysTemp(int day, System.Random rnd)
    {
        double dM = day / 120.0;
    ...
    {
        A = Convert.ToDouble(solutionArray[0]);
        B = Convert.ToDouble(solutionArray[1]);
        C = Convert.ToDouble(solutionArray[2]);
        D = Convert.ToDouble(solutionArray[3]);
        E = Convert.ToDouble(solutionArray[4]);
    }
